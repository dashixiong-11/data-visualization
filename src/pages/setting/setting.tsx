	...
	const onSubmit = e => {
		...
		if (title && content) {
			if (selectedId) {
				...
				setCardList([...cardList, { id: parseInt(Math.random() * 1000 + ''), title: title, content: content, translateX: 0, translateY: 0 }])
			}
		}
		setContent('')
		setTitle('')
		...
		<div className="setting">
			<div className="img-wrapper">
				<div id='wrapper' ref={wrapper}>
					<img src={image} className='canvas-img' draggable='false' onClick={
						() => {
							setSelectedId(null)
							sid.current = null
						}
